This is a weather App project. In this App you cand find current weather for city which name u will entered. And watch the current weather by your geolocation coordinates.
